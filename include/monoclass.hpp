 ...
 */
inline uint32_t get_class_managed_vtable(uint32_t addr) noexcept
{
 ...
 * \return uint32_t address
 */
inline uint32_t get_class_managed_klass(uint32_t addr) noexcept
{
 ...
 */
inline uint32_t get_class_offset(uint32_t addr) noexcept
{
 ...
 */
inline execode get_class_name(uint32_t addr, char *str,
 ...
 * \return EXE_OK if success
 */
inline execode get_class_namespace(uint32_t addr, char *str,
                                   int maxlen = DEF_BUFFER_STR) noexcept
{
        if (addr == ADDR_ZERO)
                return EXE_INVALID_ARGS;
 ...
 */
inline int32_t get_class_size(uint32_t addr) noexcept
{
 ...
 */
inline uint32_t get_class_runtimeinfo(uint32_t addr) noexcept
{
 ...
 */
inline uint32_t get_class_vtable_addr(uint32_t runtime_info) noexcept
{
 ...
 */
inline int32_t get_class_vtable_size(uint32_t addr) noexcept
{
 ...
 */
inline uint32_t get_class_bitfield(uint32_t addr) noexcept
{
 ...
 */
inline uint32_t get_class_fieldcount(uint32_t addr) noexcept
{
 ...
 */
inline uint32_t get_class_parent(uint32_t addr) noexcept
{
 ...
 */
inline monoclass_kind get_class_kind(uint32_t addr) noexcept
{
 ...
 */
inline bool get_class_is_value_type(uint32_t bitfield) noexcept
{
 ...
 */
inline bool get_class_is_enum(uint32_t bitfield) noexcept
{
 ...
 */
inline bool is_class_managed(monotype_code code) noexcept
{
 ...
 * \return EXE_OK if success
 */
inline execode get_class_type(uint32_t addr, monotype &type) noexcept
{
 ...
 */
inline uint32_t get_class_data_addr(uint32_t vtable_addr,
                                    int32_t vtable_size) noexcept
{
 ...
 */
int get_class_list(uint32_t assembly_addr, uint32_t *class_list,
