 ...
 */
inline uint32_t get_type_data(uint32_t addr) noexcept
{
 ...
 */
inline uint32_t get_type_attr(uint32_t addr) noexcept
{
 ...
 */
inline monotype_code get_type_code(uint32_t attrs) noexcept
{
 ...
 */
inline bool get_type_static(uint32_t attrs) noexcept
{
 ...
 */
inline bool get_type_constant(uint32_t attrs) noexcept
{
 ...
 */
inline execode get_type(uint32_t addr, monotype &mt) noexcept
{
        if (addr == ADDR_ZERO)
