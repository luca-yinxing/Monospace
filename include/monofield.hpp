 ...
 */
inline int32_t get_field_offset(uint32_t addr) noexcept
{
 ...
 */
inline execode get_field_name(uint32_t addr, char *str,
 ...
 * \return EXE_OK if success
 */
inline execode get_field_type(uint32_t addr, monotype &type) noexcept
{
 ...
 */
inline uint32_t get_vtable_field_offset(uint32_t vtable_data_addr,
