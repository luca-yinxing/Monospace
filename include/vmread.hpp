 ...
 */
execode read_data(void *buffer, uint32_t addr, uint32_t size = 1024,
                  int pid = -1) noexcept;
 ...
 * \return uint64_t
 */
inline uint64_t read_ui64(uint32_t addr, int pid = -1) noexcept
{
        uint64_t buffer;
 ...
 * \return uint32_t
 */
inline uint32_t read_ui32(uint32_t addr, int pid = -1) noexcept
{
        uint32_t buffer;
 ...
 * \return int32_t
 */
inline int32_t read_i32(uint32_t addr, int pid = -1) noexcept
{
        int32_t buffer;
 ...
 */
inline execode read_string(char *str, uint32_t addr, uint32_t maxsize = 1024,
                           int pid = -1) noexcept
{
        char buffer[maxsize];
 ...
 * \return uint16_t
 */
inline uint16_t read_ui16(uint32_t addr, int pid = -1) noexcept
{
        uint16_t buffer;
 ...
 * \return uint8_t
 */
inline uint8_t read_ui8(uint32_t addr, int pid = -1) noexcept
{
        uint8_t buffer;
 ...
 * \return execode
 */
inline execode read_string16(char16_t *str, uint32_t addr,
                             uint32_t maxsize = 1024, int pid = -1) noexcept
{
