 ...
 */
inline bool value_valid(const monovalue &value) noexcept
{
        if (value.init == false)
                return false;
 ...
 */
inline bool is_value_class_def(const monovalue &value) noexcept
{
 ...
 */
inline int get_array_count(const monovalue &array) noexcept
{
 ...
 */
execode get_array_value(const monovalue &array, int index,
 ...
 * \return EXE_OK if success
 */
execode get_array_value(const monoarray &array, int index,
                        monovalue &value) noexcept;
 ...
 * \return EXE_OK if success
 */
execode get_value(uint32_t offset_addr, monotype type,
                  monovalue &value) noexcept;
/**
 ...
 * \return EXE_OK if success
 */
execode value_managed_generic(uint32_t addr, uint32_t type_data,
                              monovalue &value);
 ...
 * \return EXE_OK if success
 */
execode value_managed_valuetype(uint32_t addr, uint32_t type_data,
                                monovalue &value);
 ...
 * \return EXE_OK if success
 */
inline execode get_value_int(monovalue &value, int &dest) noexcept
{
 ...
 */
inline uint32_t get_class(const monovalue &value) noexcept
{
        if (!value.init)
                return ADDR_ZERO;
 ...
 * \return EXE_OK if success
 */
inline execode get_class(const monovalue &value, monoclass &klass) noexcept
{
 ...
 * \return EXE_OK if success
 */
execode get_value_string(const monovalue &value, char *str,
 ...
 * \return EXE_OK if success
 */
inline execode clear_value(monovalue &value) noexcept
{
